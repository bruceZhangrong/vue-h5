<template>
  <transition :name="transitionName">
    <div ref="loginInfo" class="full-screen wrap" v-if="isShow">
      ...
      <div class="content pos-r">
        ...
        <div class="login-main flex-box">
          <img src="@/assets/images/LoginIcon.png" alt="flag" />
  ...
  methods: {
    ...
    userLogin () {
      if (this.phone_val !== '' && this.password_val !== '') {
        ...
        window.localStorage.setItem('name', this.phone_val)
        this.API({
          select_type: '',
          url: this.URL.LOGIN,
          datas: {
    ...
    getUserInfo () {
      this.API({
        ...
        success: res => {
          ...
          this.COM_FUNC.setLocalStorage(
            ['nick_name', 'phone', 'email', 'name'],
            res.data
          )
          this.$router.push({ path: '/home' })
        },
