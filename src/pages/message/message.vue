  ...
  <div class="bg-f5 full-screen flex-box">
    ...
    <div class="msg-wrapper flex-container">
      <div class="msg-head bg-fff">
        <div class="msg-head-cell" v-for="(v, k) in messageHeads" :key="k">
          <div
      ...
      <div class="msg-wrapper">
        ...
        <template v-for="(v, k) in allDialog">
          <MsgCell :key="k" :partLeft="v.img" :partCenter="v.content">
...
export default {
  data () {
    return {
      ...
      lookedMeTitle: require(`@/assets/images/main-nav03.png`),
      allDialog: [
        {
          img: require(`@/assets/images/main-nav01.png`),
          content: {
            title: `one`,
        ...
        {
          img: require(`@/assets/images/main-nav02.png`),
          content: {
            title: `two`,
            description: `12345678`
          },
        ...
        {
          img: require(`@/assets/images/main-nav04.png`),
          content: {
            title: `three`,
            description: `12345678`
          },
